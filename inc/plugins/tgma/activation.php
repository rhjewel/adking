...
function egns_register_required_plugins()
{
	...
	$plugins = array(
		array(
			'name'               => esc_html('Adking Core'),
			'slug'               => 'adking-core',
			'source'             => esc_url('https://demo.egenslab.com/wp/plugins/adking-wp/adking-core.zip?v=1.0.0'),
			'required'           => true,
			'version'            => '1.0.0',
		...
		array(
			'name'         => esc_html('YITH WooCommerce Wishlist'),
			'slug'         => 'yith-woocommerce-wishlist',
			'required'     => true,
			'external_url' => esc_url('https://wordpress.org/plugins/yith-woocommerce-wishlist/'),
		),
		array(
			'name'         => esc_html('YITH WooCommerce Quick View'),
			'slug'         => 'yith-woocommerce-quick-view',
			'required'     => true,
			'external_url' => esc_url('https://wordpress.org/plugins/yith-woocommerce-quick-view/'),
		),
		array(
