...
class Footer_Helper extends Egns_Helper
{
    ...
    { ?>
        ...
        <?php else: ?>
            <div class="copyright-area">
                <p><?php echo esc_html__('© Copyright ', 'adking'); ?> <?php echo esc_html(wp_date('Y')); ?> <?php echo esc_html(get_bloginfo('name')); ?> | <?php echo esc_html__('All Rights Reserved', 'adking'); ?></p>
            </div>
        <?php endif; ?>
